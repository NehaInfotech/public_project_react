      ...
      <Box sx={{ display: 'flex', justifyContent: 'end' }}>
        ...
        <Main open={open} sx={{ maxWidth: "100%" }}>
          ...
          <Switch>
            ...
            <Route path="/admin/component/Category">
              <CategoryPage />
            </Route>
            <Route path="/admin/component/accordion">
              <AccordionPage />
            </Route>
            <Route path="/admin/user/profile">
              <Profile />
            </Route>
            <Route path="/admin/page/contact">
              <Contact />
            </Route>
          </Switch>
